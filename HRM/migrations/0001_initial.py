    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HRM.role', verbose_name='Роль')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Оклад (повременная оплата)')),
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='HRM.department', verbose_name='Отдел')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.DateField(default=datetime.date.today, verbose_name='Период')),
                ('salary', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Оклад')),
                ('bonuses', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Премии')),
